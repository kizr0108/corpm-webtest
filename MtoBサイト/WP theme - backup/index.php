        ...
        <div class="area-top-view">
            <div class="wrapper">
                <p class="title-top-view">過去の脳MRI画像から<br>
                    新しいユーザー体験を生み出す</p>
                <p class="subtitle-top-view"><span><strong class="text-dot">認知症リスク評価</strong>プログラム</span> M-Vision brain</p>

                <a href="" class="btn-CTA">資料請求</a>
            </div>
        </div>

        <div class="area-demand">
            <div class="wrapper">
            ...
            <div class="wrapper">
                <div class="flex-2col-pc">
                    <div class="l-60">
                        ...
                        <p class="text-normal">弊社創立者の1人である森進教授主導の下、米国Johns Hopkins大学で開発されたAI技術とHIMEDIC社で蓄積された4万例以上のビッグデータから、認知症リスクとなる脳健康状態の測定を可能にしました。<br class="br-pc">
                            脳ドックを行っている多くの健診センター様にご利用いただけます。</p>
                    </div>
                    <div class="r-40">
                        <div class="img-about"></div>
                        <a href="" class="link-detail-about"><span>レポートを拡大表示する</span></a>
                    </div>
                </div>
            </div>
        </div>
